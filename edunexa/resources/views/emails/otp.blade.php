...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p class="message">
                Kami menerima permintaan untuk mereset kata sandi akun Anda di <strong>Bayn</strong>. 
                Gunakan kode OTP berikut untuk melanjutkan proses pemulihan akun Anda.
            </p>
